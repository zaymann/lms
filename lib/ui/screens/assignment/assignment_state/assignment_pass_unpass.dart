                    ...
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          ...
                          child: Container(
                            decoration: BoxDecoration(color: (widget.assignmentResponse.status == 'passed') ? AppColor.secondaryColor : HexColor.fromHex("#F44336")),
                            child: Padding(
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    widget.authorName,
                    textScaleFactor: 1.0,
                    style: TextStyle(fontSize: 14.0, color: AppColor.mainColor),
                  )
                ],
              )
            ],
