...
class _CurriculumWidgetState extends State<CurriculumWidget> with AutomaticKeepAliveClientMixin {
      ...
      case 'video':
        icon = SizedBox(
            ...
            child: SvgPicture.asset(ImageVectorPath.play,
                color:
                    (curriculumBean.has_preview) ? AppColor.mainColor : HexColor.fromHex("#2A3045").withOpacity(0.3)));
        break;
      case 'assignment':
        icon = SizedBox(
            width: 24,
  ...
  _buildQuiz(CurriculumBean curriculumBean) {
    Widget icon = SizedBox(
        ...
        height: 24,
        child: SvgPicture.asset(ImageVectorPath.question,
            color: (curriculumBean.has_preview) ? AppColor.mainColor : HexColor.fromHex("#2A3045").withOpacity(0.3)));
