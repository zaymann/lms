              ...
              child: Wrap(
                ...
                children: <Widget>[
                  if (state.finalResponse.curriculum?.lesson != null)
                    _buildCard(state, ImageVectorPath.finalPages, "#2476F5", "PAGES", "${state.finalResponse.curriculum?.lesson?.completed}/${state.finalResponse.curriculum?.lesson?.total}"),
                  if (state.finalResponse.curriculum?.multimedia != null)
                    _buildCard(
                        state, ImageVectorPath.finalVideo, "#F61B40", "VIDEO", "${state.finalResponse.curriculum?.multimedia?.completed}/${state.finalResponse.curriculum?.multimedia?.total} hrs"),
                  if (state.finalResponse.curriculum?.assignment != null)
                    _buildCard(state, ImageVectorPath.assignments, "#E9B356", "ASSIGNMENT",
                  ...
                  if (state.finalResponse.curriculum?.quiz != null)
                    _buildCard(state, ImageVectorPath.finalQuizes, "#13C79B", "QUIZES", "${state.finalResponse.curriculum?.quiz?.completed}/${state.finalResponse.curriculum?.quiz?.total}"),
                ],
              )),
          Padding(
