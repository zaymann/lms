...
class ProfileAssignmentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ProfileAssignmentBloc>(create: (c) => _bloc, child: _ProfileAssignmentScreenWidget());
  }
}
          ...
          children: <Widget>[
            Padding(
                ...
                child: SizedBox(
                    width: 100,
                    height: 100,
                    child: SvgPicture.asset(ImageVectorPath.monitor, color: HexColor.fromHex("#DDDFE3")))),
            Text(
              localizations!.getLocalization("assignment_content"),
              textScaleFactor: 1.0,
              style: TextStyle(color: HexColor.fromHex('#2A3045'), fontSize: 20.0),
